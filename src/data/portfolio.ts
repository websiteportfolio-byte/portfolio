...
// Featured work ordered to align with skills: Brand Strategy, Visual Design, UX/UI, Motion Design, Art Direction, Design Systems
export const projects: Project[] = [
  ...
  },
  {
    ...
    description: 'Vintage-inspired graphics with distressed textures and nostalgic typography. Systematic approach to typography, color, and pattern across touchpoints.',
